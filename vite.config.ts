...
export default defineConfig({
  ...
  plugins: [
    ...
    VitePWA({
      ...
      includeAssets: ['icons/vkus-doma-logo-transparent-v2.png'],
      manifest: {
        ...
        theme_color: '#A995C2',
        icons: [{ src: 'icons/vkus-doma-logo-transparent-v2.png', sizes: '1024x1024', type: 'image/png', purpose: 'any maskable' }],
      },
